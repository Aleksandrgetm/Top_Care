...
@section('email_heading', 'Pasūtījums ' . $order->display_order_number . ' ir saņemts')
...
@section('email_content')
    ...
    <div style="background-color:#f7faf7;border:1px solid #e2ece5;border-radius:22px;padding:22px 20px;">
        ...
        <p style="margin:0 0 10px 0;font-size:16px;line-height:26px;color:#355046;"><strong>Pasūtījuma numurs:</strong> {{ $order->display_order_number }}</p>
